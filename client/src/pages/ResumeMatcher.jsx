            ...
            <div className="flex items-center justify-center w-full">
              <label className="flex flex-col items-center justify-center w-full h-48 border-2 border-gray-300 border-dashed rounded-xl cursor-pointer bg-gray-50 hover:bg-gray-100 transition-all duration-300 hover:border-purple-400">
                <div className="flex flex-col items-center justify-center pt-5 pb-6">
                  ...
                  {file && (
                    <p className="mt-3 text-sm font-medium text-purple-600 flex items-center">
            ...
            <div className="mt-8">
              ...
              <div className="space-y-4">
                {matches.map((match, idx) => (
                  <div
                    key={idx}
                    className="p-5 bg-gradient-to-br from-white to-gray-50 rounded-xl border border-gray-200 hover:shadow-lg transition-all duration-300 hover:border-purple-300"
                  >
                    ...
                    {match.job?.description && (
                      <p className="text-sm text-gray-700 mb-3 line-clamp-2">{match.job.description}</p>
                    )}

                    {match.job?.skills && match.job.skills.length > 0 && (
                      <div className="flex flex-wrap gap-2">
                        {match.job.skills.slice(0, 5).map((skill, sidx) => (
                          <span
                            key={sidx}
